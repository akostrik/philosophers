...
// -fsanitize=address pour surveiller la mémoire

#include "philo.h"

static void	*thread_philo(void *ph0)
{
	t_philo	*ph;
...
static void	init(int argc, char const *argv[], t_data *d)
{
	int	i;
